...
import 'package:groshop/Theme/constantf.dart';
...
import 'package:groshop/beanmodel/walletbean/walletmodel.dart';
                              ...
                              if(!isLoading){
                                ...
                                Navigator.of(context).pushNamed(PageRoutes.stripecard).then((value){
                                  if(value!=null){
                                    ...
                                    setStripePayment(stripeBean.stripe_secret,double.parse('${rechargeController.text}'),cardPay,'INR');
                                  }else{
