...
class CartItemMainBean{
  ...
  CartItemMainBean(
      this.status, this.message, this.total_price, this.total_items, this.delivery_charge,this.store_details,this.data);
  ...
  factory CartItemMainBean.fromJson(dynamic json){
    ...
    return CartItemMainBean(json['status'], json['message'], json['total_price'], json['total_items'], json['delivery_charge'],details,daF);
  }
...
class CartStoreDetails{
  ...
  factory CartStoreDetails.fromJson(dynamic json){
    return CartStoreDetails(json['store_id'], json['store_name'], json['employee_name'], json['phone_number'],
...
class CartItemData{
  ...
  factory CartItemData.fromJson(dynamic json){
    return CartItemData(json['store_order_id'], json['product_name'], '$imagebaseUrl${json['varient_image']}', json['quantity'], json['unit'], json['varient_id'], json['qty'], json['price'], json['total_mrp'], json['order_cart_id'], json['order_date'], json['store_approval'], json['store_id'], json['description']);
  }
