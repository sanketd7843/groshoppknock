...
class WishListDataModel{
  ...
  factory WishListDataModel.fromJson(dynamic json){
    return WishListDataModel(json['wish_id'], json['user_id'], json['varient_id'], json['quantity'], json['unit'], json['price'], json['mrp'], json['product_name'], json['description'], '$imagebaseUrl${json['varient_image']}', json['store_id'], json['created_at'], json['updated_at']);
  }

  @override
  String toString() {
    return '{wish_id: $wish_id, user_id: $user_id, varient_id: $varient_id, quantity: $quantity, unit: $unit, price: $price, mrp: $mrp, product_name: $product_name, description: $description, varient_image: $varient_image, store_id: $store_id, created_at: $created_at, updated_at: $updated_at}';
  }
